        ...
        // GET, POST, or HEAD
         ...
         { 
          ...
          //Cancello
            ...
            client.println(F("<img src='http://is4001.myfoscam.org:88/cgi-bin/CGIProxy.fcgi?cmd=snapPicture2&usr=ospite&pwd=password10' style='width:100%;' border='0' alt='Null'>"));//la funzione F(), in questo modo prendono spazio nella memoria del codice che è maggiore (32Kb).
